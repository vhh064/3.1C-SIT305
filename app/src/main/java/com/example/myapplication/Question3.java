...
public class Question3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton = findViewById(R.id.submit_button3); // Using consistent IDs across activities
        nextQuestionButton = findViewById(R.id.next_question_button3); // Using consistent IDs across activities
        ...
        final int correctAnswerId = R.id.answer3; // Assume R.id.answer2 is the ID of the correct answer RadioButton
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedId == -1) {
                    Toast.makeText(Question3.this, "Please select an answer.", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        nextQuestionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Question3.this, Question4.class); // Assuming Question3 exists
    ...
    private void showToastAndHighlightAnswer(String message, int color, int selectedId) {
        Toast.makeText(Question3.this, message, Toast.LENGTH_SHORT).show();
