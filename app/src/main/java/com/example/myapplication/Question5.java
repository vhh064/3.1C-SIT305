...
public class Question5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton = findViewById(R.id.submit_button5); // Using consistent IDs across activities
        nextQuestionButton = findViewById(R.id.next_question_button5); // Using consistent IDs across activities
        ...
        final int correctAnswerId = R.id.answer4; // Assume R.id.answer2 is the ID of the correct answer RadioButton
        ...
        nextQuestionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Question5.this, Result.class); // Assuming Question3 exists
    ...
    private void showToastAndHighlightAnswer(String message, int color, int selectedId) {
        Toast.makeText(Question5.this, message, Toast.LENGTH_SHORT).show();
