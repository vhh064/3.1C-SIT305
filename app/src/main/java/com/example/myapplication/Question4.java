...
public class Question4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton = findViewById(R.id.submit_button4); // Using consistent IDs across activities
        nextQuestionButton = findViewById(R.id.next_question_button4); // Using consistent IDs across activities
        ...
        final int correctAnswerId = R.id.answer1;
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedId == -1) {
                    Toast.makeText(Question4.this, "Please select an answer.", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        nextQuestionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Question4.this, Question5.class); // Assuming Question3 exists
    ...
    private void showToastAndHighlightAnswer(String message, int color, int selectedId) {
        Toast.makeText(Question4.this, message, Toast.LENGTH_SHORT).show();
